...
<h1 align="center">Passthrough SSD or HDD on PVE</h1>
...
```bash
ls -n /dev/disk/by-id/
-> Result Example:  ata-GIGABYTE_GP-GSTFS31240GNTD_SN182808964756

-> Next command down below	
qm set 10001 -scsi1 /dev/disk/by-id/ata-GIGABYTE_GP-GSTFS31240GNTD_SN182808964756,discard=on,ssd=1
```
---
